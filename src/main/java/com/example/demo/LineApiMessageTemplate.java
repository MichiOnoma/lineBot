...
public final class LineApiMessageTemplate {
	...
	public static TemplateMessage getKeywordTemp() {
		...
		new CarouselColumn(LineApiConst.URL.MYSELF_URL, LineApiConst.TITLE.MYSELF, LineApiConst.MESSAGE.SONOTA,
				Arrays.asList(
		...
		new CarouselColumn(LineApiConst.URL.MYSELF_URL, LineApiConst.TITLE.MYHEALTH, LineApiConst.KEYWORD.SONOTA,
				Arrays.asList(
		...
		new CarouselColumn(LineApiConst.URL.MYSELF_URL, LineApiConst.TITLE.MYLINK, LineApiConst.KEYWORD.SONOTA,
				Arrays.asList(
		...
		new CarouselColumn(LineApiConst.URL.MYSELF_URL, LineApiConst.TITLE.MYFUTURE, LineApiConst.KEYWORD.SONOTA,
				Arrays.asList(
		...
		new CarouselColumn(LineApiConst.URL.MYSELF_URL, LineApiConst.TITLE.MYFUTURE2, LineApiConst.KEYWORD.SONOTA,
				Arrays.asList(
		...
		new CarouselColumn(LineApiConst.URL.MYSELF_URL, LineApiConst.TITLE.FUTURE, LineApiConst.KEYWORD.SONOTA,
				Arrays.asList(
		...
		new CarouselColumn(LineApiConst.URL.MYSELF_URL, LineApiConst.TITLE.FORME, LineApiConst.KEYWORD.SONOTA,
				Arrays.asList(
